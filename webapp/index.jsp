...
<body style="background-color: #f1efeb">
	<center>
		...
		<a href="/post/list" style="color: orange"> 서비스 둘러보기 </a><br> <br>
		<c:choose>
			...
			<c:when test="${empty sessionScope.username}">
				<a href = "/join" style="color: pink"> 회원 가입하기 </a>
				<form action="/logincheck" method="post">
					<br />
					<h3 style="color: orange">제 이름은</h3>
					<input type="text" name="username"> <br />
					<h3 style="color: orange">제 비밀번호는</h3>
